...
class ImeSwitchWindow(private val mContext: Context?) {
    ...
    fun showImeSwitchView() {
        ...
        windowContentView =
            LayoutInflater.from(mContext).inflate(R.layout.layout_ime_switch, null) as ViewGroup
        ...
        var recyclerLayoutParams: ViewGroup.LayoutParams =
    ...
    private fun updateInputMethodEnable(inputMethodInfo: InputMethodInfo, isChecked: Boolean) {
        ...
        val enabledIMEsAndSubtypesMap: HashMap<String, HashSet<String>> =
            getEnabledInputMethodsAndSubtypeList(mContext!!.getContentResolver())
        val strings = enabledIMEsAndSubtypesMap.get(id)
        if (strings != null) {
            enabledIMEsAndSubtypesMap.clear()
            enabledIMEsAndSubtypesMap[id] = strings
            val textImiString: String =
                buildInputMethodsAndSubtypesString(enabledIMEsAndSubtypesMap)
    ...
    private fun getEnabledInputMethodsAndSubtypeList(
        resolver: ContentResolver
    ): java.util.HashMap<String, java.util.HashSet<String>> {
        val enabledInputMethodsStr =
    ...
    fun parseInputMethodsAndSubtypesString(
        inputMethodsAndSubtypesString: String?
    ): java.util.HashMap<String, java.util.HashSet<String>> {
    ...
    fun buildInputMethodsAndSubtypesString(
        imeToSubtypesMap: HashMap<String, HashSet<String>>
    ): String {
    ...
    private fun generateLayoutParams(
        ...
        val marginStart = resources.getDimension(R.dimen.ime_switch_window_margin).toInt()
