    ...
    override fun onInterceptTouchEvent(ev: MotionEvent?): Boolean {
        ...
        when (ev!!.action) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                Log.d(
                    TAG,
                    "onInterceptTouchEvent: dx:$dx dy:$dy slop:${ViewConfiguration.get(context).scaledTouchSlop}"
                )
    ...
    private fun handleTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
                ...
                //                if (mIsHorizontalScroll) {
            {
                ...
                //
                //                    val toIndex = max(0.0, min(next.toDouble(), (adapter!!.count -
                // 1).toDouble()))
                //                        .toInt()
                //                    setCurrentItem(
                //                        toIndex, true
