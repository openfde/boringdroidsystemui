...
class TopBarImeSwitchWindow(
    ...
    private fun updateInputMethodEnable(inputMethodInfo: InputMethodInfo, isChecked: Boolean) {
        ...
        val enabledIMEsAndSubtypesMap: HashMap<String, HashSet<String>> =
            getEnabledInputMethodsAndSubtypeList(getContext().contentResolver)
    ...
    private fun buildInputMethodsAndSubtypesString(
    ...
    private fun parseInputMethodsAndSubtypesString(
